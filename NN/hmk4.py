...
def create_model(trial):
    ...
    model.add(tf.keras.layers.Conv2D(filters=32,kernel_size=(3,3),activation="relu",input_shape=in_shape))
...
def get_mnist():
    ...
    return train_ds, valid_ds,x_train.shape[1:]
...
def objective(trial):
    # Get MNIST data.
    train_ds, valid_ds,in_shape = get_mnist()
